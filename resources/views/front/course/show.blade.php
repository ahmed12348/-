                ...
                <div class="col-lg-12">
                    <div class="breadcrumb_iner text-center">
                        <div class="breadcrumb_iner_item">
                            ...
                            <p>Home Page<span>/</span>Courses<span>/</span>{{$courses->cat->name}}<span>/</span>{{$courses->name}}</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="course_details_area section_padding">
        <div class="container">
            <div class="row">
                ...
                @csrf
                <div class="row">
                <input name="course_id" value="{{$courses->id}}" type="hidden">
                ...
                <div class="col-12">
                    <div class="form-group">
                    <input class="form-control" name="spec"  type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Speciality'" placeholder = 'Enter Your Speciality'>
                    </div>
                </div>
                </div>
